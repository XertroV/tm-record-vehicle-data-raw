...
[Setting category="Performance" name="Frametime Overhead Limit Whilst Saving (ms)" min="0" max="19" description="Take 1+value miliseconds per-frame on average when saving vehicle data. Increase to save faster but increase frame times. At low values there will be no impact (CPU dependent)."]
